...
/*基隆火車站2020年,每月份進站人數*/
SELECT DATE_TRUNC('month',日期) AS 月份,SUM(進站人數) AS 基隆火車站進站總人數
FROM gate_count LEFT JOIN stations ON 站點編號 = 編號
WHERE 名稱 = '基隆' AND 日期 BETWEEN '2020-01-01' AND '2020-12-31'
GROUP BY 月份
ORDER BY 月份, 基隆火車站進站總人數



/*基隆火車站2020年,每月份進站人數,由多至少*/
SELECT DATE_TRUNC('month',日期) AS 月份,SUM(進站人數) AS 基隆火車站進站人數
FROM gate_count LEFT JOIN stations ON 站點編號 = 編號
WHERE 名稱 = '基隆' AND 日期 BETWEEN '2020-01-01' AND '2020-12-31'
GROUP BY 月份
ORDER BY 基隆火車站進站人數 DESC



/*基隆火車站2020,2021,2022,每年進站人數*/
SELECT DATE_PART('year',日期) AS 年度,SUM(進站人數) AS 基隆火車站進站人數
FROM gate_count LEFT JOIN stations ON 站點編號 = 編號
